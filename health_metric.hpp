...
using MetricExceedError = sdbusplus::error::xyz::openbmc_project::metric::Threshold::ExceedThreshold;
using MetricBelowError = sdbusplus::error::xyz::openbmc_project::metric::Threshold::BelowThreshold;
