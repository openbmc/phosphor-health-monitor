...
using ValueInterface = sdbusplus::xyz::openbmc_project::Metric::server::Value;
using PathInterface =
...
using HealthMetricValue = std::tuple<double, double>;
...
class HealthMetric : public HealthMetricInterface
{
  public:
    ...
    virtual void updateHealthMetric(HealthMetricValue value);
