...
namespace UtilsIntf = phosphor::health::utils;
...
TEST_F(HealthMetricCollectionTest, TestHealthMetricCollectionCreation)
{
    ...
    constexpr auto BMCInventoryItem = sdbusplus::common::xyz::openbmc_project::
        inventory::item::Bmc::interface;
    auto bmcPaths = UtilsIntf::findPaths(bus, BMCInventoryItem);
